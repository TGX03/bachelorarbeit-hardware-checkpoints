...
In addition, they only used the QEMU Human Monitor (QHM\footnote{\Citeauthor{kitcheckpoints} uses HMP instead of QHM in his thesis, however both terms refer to the same protocol and both are in use.})
