...
\begin{itemize}
    ...
    or are accounted for and compensated.
...
In addition, he has only used the QEMU Human Monitor (QHM\footnote{\Citeauthor{kitcheckpoints} uses HMP instead of QHM in his thesis, however both terms refer to the same protocol and both are in use.})
