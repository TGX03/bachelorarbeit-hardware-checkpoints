...
In addition, he uses the QEMU Human Monitor Protocol (QHM\footnote{\Citeauthor{kitcheckpoints} uses HMP instead of QHM in his thesis, however they refer to the same protocol and both are in use.}) to communicate with QEMU.
