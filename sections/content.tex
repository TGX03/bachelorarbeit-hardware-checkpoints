...
This of course gets used to back up the necessary files later on.
...
Still, it's the only straightforward option to access the guest memory.
...
the following rules are presumed in the hope they are valid for the majority of architectures:
