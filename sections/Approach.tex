...
and the specification allowing for up to 8800MT/s\cite{JEDEC},
...
depending on speed and quality of the chips chosen\cite[p.392-406]{JEDEC},
with overclocked memory being available allowing for even lower latencies.
